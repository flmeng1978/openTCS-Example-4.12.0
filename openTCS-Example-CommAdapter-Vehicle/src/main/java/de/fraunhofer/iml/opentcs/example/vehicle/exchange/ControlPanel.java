...
import de.fraunhofer.iml.opentcs.example.vehicle.ExampleProcessModel;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SendRequestCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetDisconnectingOnVehicleIdleCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetIdleTimeoutCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetLoggingEnabledCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetReconnectingOnConnectionLossCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetVehicleHostCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.exchange.commands.SetVehiclePortCommand;
import de.fraunhofer.iml.opentcs.example.vehicle.telegrams.OrderAction;
